...
print(f"PCA completed: {X_train.shape[1]} -> {pca_components} dimensions")
...
train_acc = accuracy_score(y_train, knn_clf.predict(X_train_pca))
test_acc = accuracy_score(y_test, knn_clf.predict(X_test_pca))
print(f"KNN - Train Acc: {train_acc:.4f} - Test Acc: {test_acc:.4f}")

joblib.dump(knn_clf, "knn_model_pca.pkl")
joblib.dump(pca, "pca_transform.pkl")
print(f"✅ KNN model saved to knn_model_pca.pkl")
print(f"✅ PCA transform saved to pca_transform.pkl")
