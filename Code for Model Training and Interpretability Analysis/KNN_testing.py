...
knn_model_path = "knn_model_pca.pkl"
pca_model_path = "pca_transform.pkl"
cf2_mass = 49.9968
ppm_tol = 5
max_msms_bin = 9500
max_nl_bin = 5000
...
knn_clf = joblib.load(knn_model_path)
pca = joblib.load(pca_model_path)

X_test = np.array([test_dataset[i][0] for i in range(len(test_dataset))], dtype=np.float32)
y_true = np.array([test_dataset[i][1] for i in range(len(test_dataset))], dtype=np.int64)
