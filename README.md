...
The NIST 2020 MS/MS library can be exported following the instructions provided in MassFormer: https://github.com/Roestlab/massformer?tab=readme-ov-file#exporting-the-nist-data.

GNPS spectral libraries can be downloaded from: https://external.gnps2.org/gnpslibrary.
